...
(function initHeroCanvas() {
  ...
  function drawCanvas() {
    ...
    /* Radial glows — concentrated on right side where robot is */
    const glows = [
      { x: 0.72, y: 0.38, color: 'rgba(41,121,255,.07)',  r: W * 0.55 },
      { x: 0.82, y: 0.60, color: 'rgba(123,47,255,.06)',  r: W * 0.40 },
      { x: 0.60, y: 0.25, color: 'rgba(0,229,255,.04)',   r: W * 0.35 },
      { x: 0.78, y: 0.50, color: 'rgba(255,179,0,.03)',   r: W * 0.25 },
    ];
